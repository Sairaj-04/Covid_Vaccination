...
public class VaccineInventory {
	...
	public VaccineInventory(Integer inventoryId, LocalDate date, List<VaccinationCenter> listvaccinationCenter,
			List<VaccineCount> vaccinecountList) {
		super();
	...
	public String toString() {
		return "VaccineInventory [inventoryId=" + inventoryId + ", date=" + date + ", ListvaccinationCenter="
